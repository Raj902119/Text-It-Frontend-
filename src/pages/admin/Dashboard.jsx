...
import { DoughnutChart, LineChart } from '../../Special/Charts'
import AdminLayout from '../../components/Layout/AdminLayout'
import Loaders from '../../components/Layout/Loaders'
import { CurveButton, SearchField } from '../../components/Styled/StyledComponents'
  ...
  return (
    <AdminLayout>
        ...
        <Stack direction={{xs:"column",lg:"row"}} sx={{gap: "2rem"}} flexWrap={"wrap"} justifyContent={"center"} alignItems={{xs:"center",lg:"stretch"}}>
            ...
            <LineChart value={stats?.chartMessages || []}/>
            </Paper>
